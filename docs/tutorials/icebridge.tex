...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=1.0]{/assets/img/tutorials/icebridge/Mesh.png}
	\end{center}
\end{figure}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=1.0]{/assets/img/tutorials/icebridge/Mesh2.png}
	\end{center}
\end{figure}
...
\begin{figure}[H]
	\begin{center}
	\includegraphics[scale=2.7]{/assets/img/tutorials/icebridge/Jakobshavn.png}
\end{center}
\end{figure}
...
\begin{figure}[H]
	\begin{center}
	\includegraphics[scale=1.0]{/assets/img/tutorials/icebridge/SurfaceElevation.png}
...
\begin{figure}[H]
	\begin{center}
	\includegraphics[scale=1.0]{/assets/img/tutorials/icebridge/Thickness.png}
...
\begin{figure}[H]
	\begin{center}
	\includegraphics[scale=1.0]{/assets/img/tutorials/icebridge/Base.png}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=1.0]{/assets/img/tutorials/icebridge/Differences.png}
	\end{center}
\end{figure}
%}}}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=1.8]{/assets/img/tutorials/icebridge/Velocity2.png}
		\includegraphics[scale=1.8]{/assets/img/tutorials/icebridge/FrictCoef.png}
	\end{center}
\end{figure}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=1.09]{/assets/img/tutorials/icebridge/TransientSolution.png}
	\end{center}
\end{figure}
You can plot time series of surface mass balance, mean velocity and ice volume:
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=1.09]{/assets/img/tutorials/icebridge/MassVelocityVolume.png}
	\end{center}
\end{figure}
