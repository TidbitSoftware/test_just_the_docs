...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=1.0]{../../../images/issm/documentation/tutorials/greenland/Mesh.png}
	\end{center}
\end{figure}
%}}}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=1.0]{../../../images/issm/documentation/tutorials/greenland/Thickness.png}
	\end{center}
\end{figure}

\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=1.0]{../../../images/issm/documentation/tutorials/greenland/Velocity.png}
	\end{center}
\end{figure}
%}}}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=0.25]{../../../images/issm/documentation/tutorials/greenland/TransientSMB.png}
	\end{center}
\end{figure}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=0.25]{../../../images/issm/documentation/tutorials/greenland/ThicknessVelocity.png}
	\end{center}
\end{figure}

\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=1.07]{../../../images/issm/documentation/tutorials/greenland/Transient.png}
	\end{center}
\end{figure}
%}}}
\subsection{Exercise} %{{{
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=0.9]{../../../images/issm/documentation/tutorials/greenland/HistoricalMassBalance.png}
	\end{center}
\end{figure}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=1.1]{../../../images/issm/documentation/tutorials/greenland/Transient2.png}
	\end{center}
\end{figure}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=1.1]{../../../images/issm/documentation/tutorials/greenland/200TimeSeries.png}
	\end{center}
\end{figure}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=1.05]{../../../images/issm/documentation/tutorials/greenland/MassVelocityVolume.png}
	\end{center}
\end{figure}
