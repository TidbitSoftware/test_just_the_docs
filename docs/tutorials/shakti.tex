...
\begin{figure}[H]
	\begin{center}
		\includegraphics{/assets/img/tutorials/shakti/moulin_mesh.png}
	\end{center}
\end{figure}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics{/assets/img/tutorials/shakti/moulin_initial.png}
	\end{center}
\end{figure}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics{/assets/img/tutorials/shakti/moulin_final.png}
	\end{center}
\end{figure}
