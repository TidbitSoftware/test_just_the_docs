...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=2.8]{/assets/img/tutorials/ismip/SquareIceFlow.png}
	\end{center}
\end{figure}
%}}}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=0.9]{/assets/img/tutorials/ismip/Mesh.png}
	\end{center}
\end{figure}
...
\begin{itemize}
	...
	\item All grounded: default
		...
		\begin{figure}[H]
			\begin{center}
				\includegraphics[scale=0.9]{/assets/img/tutorials/ismip/Mesh2.png}
			\end{center}
		\end{figure}
		%}}}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=0.9]{/assets/img/tutorials/ismip/Parameterize1.png}
	\end{center}
\end{figure}
%}}}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=0.9]{/assets/img/tutorials/ismip/Extrusion1.png}
	\end{center}
\end{figure}
%}}}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=0.9]{/assets/img/tutorials/ismip/BoundaryCondition.png}
	\end{center}
\end{figure}
%}}}
\subsection{Test F} %{{{
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=2.7]{/assets/img/tutorials/ismip/RedSquareFlow.png}
	\end{center}
\end{figure}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=0.8]{/assets/img/tutorials/ismip/UpperSurface2.png}
	\end{center}
\end{figure}
Top view:
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=2.7]{/assets/img/tutorials/ismip/UpperSurfaceVelocity.png}
	\end{center}
\end{figure}
%}}}
