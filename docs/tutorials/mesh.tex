...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=0.7]{/assets/img/tutorials/mesh/mesh1.png}
	\end{center}
\end{figure}
%}}}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=0.7]{/assets/img/tutorials/mesh/mesh2.png}
	\end{center}
\end{figure}
%}}}
\subsection{Triangle}%{{{
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=0.7]{/assets/img/tutorials/mesh/mesh3.png}
	\end{center}
\end{figure}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=0.7]{/assets/img/tutorials/mesh/mesh4.png}
	\end{center}
\end{figure}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=0.7]{/assets/img/tutorials/mesh/mesh5.png}
	\end{center}
\end{figure}
%}}}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=0.7]{/assets/img/tutorials/mesh/shock0.png}
	\end{center}
\end{figure}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=0.7]{/assets/img/tutorials/mesh/shock1.png}
	\end{center}
\end{figure}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=0.7]{/assets/img/tutorials/mesh/shock2.png}
	\end{center}
\end{figure}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=0.7]{/assets/img/tutorials/mesh/shock3.png}
	\end{center}
\end{figure}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=0.7]{/assets/img/tutorials/mesh/shock4.png}
	\end{center}
\end{figure}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=0.7]{/assets/img/tutorials/mesh/exptool.png}
	\end{center}
\end{figure}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=0.7]{/assets/img/tutorials/mesh/refine1.png}
	\end{center}
\end{figure}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=0.7]{/assets/img/tutorials/mesh/refine2.png}
	\end{center}
\end{figure}
%}}}
