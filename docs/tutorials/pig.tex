...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=0.9]{../../../images/issm/documentation/tutorials/pig/exptool.png}
	\end{center}
\end{figure}
...
\begin{figure}[H]
	\begin{center}
	\includegraphics[scale=1.0]{../../../images/issm/documentation/tutorials/pig/Mesh.png}
	\end{center}
\end{figure}
%}}}
\subsection{Mask}%{{{
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=1.1]{../../../images/issm/documentation/tutorials/pig/Mask2.png}
	\end{center}
\end{figure}
%}}}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=1.0]{../../../images/issm/documentation/tutorials/pig/ControlMethod.png}
	\end{center}
\end{figure}
%}}}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=1.2]{../../../images/issm/documentation/tutorials/pig/Plot.png}
	\end{center}
\end{figure}
%}}}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=1.2]{../../../images/issm/documentation/tutorials/pig/VelocityComparison.png}
	\end{center}
\end{figure}
%}}}
