...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=0.9]{/assets/img/tutorials/pig/exptool.png}
	\end{center}
\end{figure}
...
\begin{figure}[H]
	\begin{center}
	\includegraphics[scale=1.0]{/assets/img/tutorials/pig/Mesh.png}
	\end{center}
\end{figure}
%}}}
\subsection{Mask}%{{{
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=1.1]{/assets/img/tutorials/pig/Mask2.png}
	\end{center}
\end{figure}
%}}}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=1.0]{/assets/img/tutorials/pig/ControlMethod.png}
	\end{center}
\end{figure}
%}}}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=1.2]{/assets/img/tutorials/pig/Plot.png}
	\end{center}
\end{figure}
%}}}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=1.2]{/assets/img/tutorials/pig/VelocityComparison.png}
	\end{center}
\end{figure}
%}}}
