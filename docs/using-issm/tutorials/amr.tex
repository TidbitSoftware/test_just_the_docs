...
\begin{figure}[H]
	\begin{center}
		\includegraphics{/assets/img/using-issm/tutorials/amr/amr_coarse_mesh.jpg}
	\end{center}
\end{figure}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics{/assets/img/using-issm/tutorials/amr/amr_surface_initial.png}
	\end{center}
\end{figure}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics{/assets/img/using-issm/tutorials/amr/amr_surface_final.png}
	\end{center}
\end{figure}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics{/assets/img/using-issm/tutorials/amr/amr_mask_final.png}
	\end{center}
\end{figure}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics{/assets/img/using-issm/tutorials/amr/amr_meshes.jpg}
	\end{center}
\end{figure}
