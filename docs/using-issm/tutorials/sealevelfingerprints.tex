...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=2.8]{/assets/img/using-issm/tutorials/sealevelfingerprints/Mesh.png}
	\end{center}
\end{figure}
%}}}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=2]{/assets/img/using-issm/tutorials/sealevelfingerprints/Weh.png}
	\end{center}
\end{figure}
%}}}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=2]{/assets/img/using-issm/tutorials/sealevelfingerprints/Rsl.png}
	\end{center}
\end{figure}
%}}}
