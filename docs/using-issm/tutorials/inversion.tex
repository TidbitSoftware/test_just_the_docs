...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=0.9]{/assets/img/using-issm/tutorials/inversion/step1.png}
	\end{center}
\end{figure}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=0.9]{/assets/img/using-issm/tutorials/inversion/step2.png}
	\end{center}
\end{figure}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=0.9]{/assets/img/using-issm/tutorials/inversion/step3.png}
	\end{center}
\end{figure}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=0.9]{/assets/img/using-issm/tutorials/inversion/step4.png}
	\end{center}
\end{figure}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=0.9]{/assets/img/using-issm/tutorials/inversion/step1b.png}
	\end{center}
\end{figure}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=0.9]{/assets/img/using-issm/tutorials/inversion/step2b.png}
	\end{center}
\end{figure}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=0.9]{/assets/img/using-issm/tutorials/inversion/step3b.png}
	\end{center}
\end{figure}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=0.9]{/assets/img/using-issm/tutorials/inversion/step3b_log.png}
	\end{center}
\end{figure}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=0.9]{/assets/img/using-issm/tutorials/inversion/step3c.png}
	\end{center}
\end{figure}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=0.9]{/assets/img/using-issm/tutorials/inversion/step4b.png}
	\end{center}ls
